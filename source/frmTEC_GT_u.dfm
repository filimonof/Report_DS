inherited frmTEC_GT: TfrmTEC_GT
  Left = 393
  Top = 383
  Width = 651
  Height = 378
  Caption = #1043#1058' '#1058#1069#1062' '#1085#1072' 6:00'
  ...
  object cxGrid1: TcxGrid [5]
    ...
    object cxGrid1DBBandedTableView1: TcxGridDBBandedTableView
      NavigatorButtons.ConfirmDelete = False
      DataController.DataSource = dsTecGT
      ...
      object cxGrid1DBBandedTableView1tg1: TcxGridDBBandedColumn
        Caption = #1058#1043'-1'
        DataBinding.FieldName = 'tg1'
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Width = 100
      ...
      object cxGrid1DBBandedTableView1tg2: TcxGridDBBandedColumn
        Caption = #1058#1043'-2'
        DataBinding.FieldName = 'tg2'
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Width = 100
        Position.BandIndex = 1
  ...
  object adsTecGT: TADODataSet
    Connection = dmData.adcData
    CursorType = ctStatic
    OnFieldChangeComplete = adsTecGTFieldChangeComplete
    CommandText = 'tec_gt'
    CommandType = cmdTableDirect
    Parameters = <>
    Left = 152
    Top = 128
    object adsTecGTID: TAutoIncField
      FieldName = 'ID'
      ReadOnly = True
    end
    object adsTecGTdate: TDateTimeField
      FieldName = 'date'
    end
    object adsTecGTtg1: TWideStringField
      FieldName = 'tg1'
      Size = 50
    end
    object adsTecGTtg2: TWideStringField
      FieldName = 'tg2'
      Size = 50
    end
    object adsTecGTgen: TWideStringField
      FieldName = 'gen'
      Size = 50
    end
    object adsTecGTgaz_g: TWideStringField
      FieldName = 'gaz_g'
      Size = 50
    end
    object adsTecGTgaz_p: TWideStringField
      FieldName = 'gaz_p'
      Size = 50
    end
  end
  object dsTecGT: TDataSource
    DataSet = adsTecGT
    Left = 152
    Top = 160
  end
